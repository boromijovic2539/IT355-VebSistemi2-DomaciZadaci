 ...
 */
package com.it355.boromijovic.aspect;
...
public class InterceptorLog implements MethodBeforeAdvice {
    ...
    @AfterThrowing(pointcut = "execution(*com.it355.boromijovic.dao.impl.KartaDaoImpl.addKartaThrowException())", throwing = "error")
    ...
    @Around("execution(* execution(*com.it355.boromijovic.dao.impl.KartaDaoImpl.addKartaAround (..))")
